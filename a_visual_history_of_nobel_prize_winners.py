...
Original file is located at
    https://colab.research.google.com/drive/1KZZsfmz0RksXaAt1Xp-Zl9nmnapO-tEO
...
display(nobel.query('1901<year<2016'))
...
#nobel.query('birth_country=="United States of America"')
#nobel['usa_born_winner']= nobel.query('birth_country=="United States of America"')
...
first_woman.nsmallest(1,'female_winner')
...
display(nobel.age)
#display(nobel['birth_date'].dt.year)
#nobel['birth_date']
# Plotting the age of Nobel Prize winners
sns.lmplot(data=nobel, x='year', y='age',lowess=True,line_kws={'color' : 'black'},aspect=2)
...
nobel.nlargest(1,['age','year'])

# The youngest winner of a Nobel Prize as of 2016
nobel.nsmallest(1,['age','year'])
